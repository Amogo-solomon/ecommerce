  ...
  return (
    <div className='outline-none border-none relative'>
      ...
      sm:p-0 rounded-lg sm:rounded-none'>
        ...
        <div className='bg-accent text-while text-[14px] md:text-[16px] p-2 px-4  rounded-lg 
      ...
      <Image 
        className="w-[100%] h-[300px] md:h-auto rounded-xl object-cover object-right md:object-left-botton"
        src={img}
        alt="banner"
        width={2000}
        height={2000} 
